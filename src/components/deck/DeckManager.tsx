...
import { X, Plus, Trash2, Edit3, Tag, Layers, Check } from 'lucide-react';
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-bold text-[var(--text-muted)] uppercase tracking-wider">
                      Cards List ({initialDeck?.cards.length || 0})
                    </span>
                    <button
                      onClick={() => setIsAddingNewCard(true)}
                      className="px-3.5 py-1.5 rounded-full bg-[var(--primary)] text-white text-xs font-bold flex items-center gap-1.5 hover:bg-[var(--primary-hover)] transition-colors shadow-xs"
                    >
                  ...
                  <div className="space-y-2.5">
                    {initialDeck?.cards.map((card, idx) => (
                      <div
                        key={card.id}
                      ...
                      >
                        <div className="flex-1 min-w-0 space-y-1">
                          <div className="flex items-center gap-2">
                            <span className="w-5 h-5 rounded-lg bg-[var(--border-color)] text-[10px] font-bold flex items-center justify-center text-[var(--text-muted)]">
                              {idx + 1}
                            </span>
                        ...
                        <div className="flex items-center gap-1 flex-shrink-0">
                          <button
                            ...
                            className="p-1.5 rounded-xl text-[var(--text-subtle)] hover:text-[var(--primary)] hover:bg-[var(--bg-surface)] transition-colors"
                          >
                          ...
                          {onDeleteCard && initialDeck && (
                            <button
                              ...
                              className="p-1.5 rounded-xl text-[var(--text-subtle)] hover:text-rose-500 hover:bg-[var(--bg-surface)] transition-colors"
                            >
